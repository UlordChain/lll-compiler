...
import static co.usc.lll.asm.OpCode.Tier.*;
...
public enum OpCode {
    ...
    /**
     * (0xf5) Mark this contract to Hibernate
     */
    HIBERNATE(0xf5, 0, 0, ZeroTier,1),
    /**
     * (0xf6) Wakeup a contract from Hibernatation. Sends address, code content as ofs/len
     */
    WAKEUP(0xf6, 5, 0, ZeroTier,1),
    /**
     * (0xf7) ACCEPTVALUE
     */
    ACCEPTVALUE(0xf7, 1, 0, ZeroTier,1),
    /**
     * (0xf8) NOP
     */
    NOP(0xf8, 0, 0, ZeroTier,1),
    /**
     * (0xf9) Sends ether, but does not call code. scriptVersion 1
     */
    SEND(0xf9, 2, 0, ZeroTier,1),
    /**
     * (0xff) Halt execution and register account for
     * later deletion
     */
    HEADER(0xfe, 0, 0, ZeroTier),
    /**
     * (0xff) Halt execution and register account for
     * later deletion
     */
